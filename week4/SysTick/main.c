...
const double songspeed = 1.5; //Change to 2 for a slower version of the song, the bigger the number the slower the song
//*****************************************
...
#define NOTE_B5  988
//*****************************************
uint32_t notes[] = {       //Note of the song, 0 is a rest/pulse
...
//*****************************************
uint32_t duration[] = {         //duration of each note (in ms) Quarter Note is set to 250 ms
  125, 125, 250, 125, 125, 
  125, 125, 250, 125, 125,
  125, 125, 250, 125, 125,
  125, 125, 375, 125, 
...
void playSong(void)
{
		...
		{   //203 is the total number of music notes in the song
				...
				playNote(notes[i], wait);  //tone(pin,frequency,duration)
